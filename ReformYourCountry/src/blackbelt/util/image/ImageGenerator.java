 ...
 *
 * Torsten Romer, 2003-05-22: Made some slight modifications so that this
...
public class ImageGenerator implements ImageConsumer
{
     ...
     *
     * Torsten Romer: Ignore the status to make sure the process "finishes".
     ...
     *
     * Torsten Romer: Changed to public
     *
     ...
     * the current image.
     *
     * Torsten Romer: Use another constructor of BufferedImage. With the one used

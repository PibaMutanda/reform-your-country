        ...
        if (user !=null){
            ...
            if (isGrouped) {
                ...
                footer += "<br>group option is "
                    ...
                    + "<a href='" + UrlUtil.getAbsoluteUrl(new ParamPageResource(MailChangeOptionPage.class, user, userSecurityString, secondDelayOption) ) + "'>"
                    + secondDelayOption
                    + "</a> or "
                    
                    + "<a href='" + UrlUtil.getAbsoluteUrl( new ParamPageResource(MailChangeOptionPage.class, user, userSecurityString, thirdDelayOption) ) + "'>"
                    + thirdDelayOption
                    + "</a>";
            }
            if(isNewsletter){

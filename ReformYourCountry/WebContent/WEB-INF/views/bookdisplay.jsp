...
<html>
<body>
    <ryctag:pageheadertitle title="${book.title} ${book.subtitle}"> <ryctag:breadcrumbelement label="bibliographie" link="/book"/><ryctag:breadcrumbelement label="ce livre" /></ryctag:pageheadertitle>

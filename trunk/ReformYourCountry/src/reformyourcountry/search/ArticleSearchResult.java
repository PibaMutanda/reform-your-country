...
public class ArticleSearchResult {
	...
	public List<ArticleSearchUnit> results= new ArrayList<ArticleSearchUnit>();
	...
	public ArticleSearchResult(ScoreDoc[] scoreDocs, String keyWord, IndexManagerService indexManagerService, ArticleRepository articleRepository){
		...
		for(ScoreDoc scoreDoc : scoreDocs){
			...
			this.results.add(new ArticleSearchUnit(articleDocument, article));
	...
	public List<ArticleSearchUnit> getResults() {
		return results;
	}

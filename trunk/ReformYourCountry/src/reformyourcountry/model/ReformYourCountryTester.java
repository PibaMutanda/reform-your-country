...
public class ReformYourCountryTester {
	...
	public static void main(String[] args) {
	  ...
	  // crée un article
	  Article art = new Article ("l'obligation scolaire","    la législation oblige les enfants a aller a l'ecole jusqu'a 18 ans");
	  Article art2 = new Article ("les enfants a l'ecole", "   les enfants ont droit a une education");

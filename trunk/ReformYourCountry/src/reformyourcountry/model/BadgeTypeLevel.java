...
public enum BadgeTypeLevel {
    ...
    GOLD    ("Or","Les gommettes d'or sont rares. Vous aurez à travailler activemment pour ça. Elles sont en quelque sorte un exploit!"),
	...
	BRONZE  ("Verte","Les gommettes vertes sont décernées pour une utilisation basique. Elles sont faciles à gagner.");
